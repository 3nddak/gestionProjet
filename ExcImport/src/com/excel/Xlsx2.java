...
public class Xlsx2 {
	...
	public static void main(String[] args) {
       ...
       j=0;
				try {
					...
					cp = 0;
					metier.ajouterSinistreDetail(new SinistreDetail(verifieObjetDate(values.get(0), i, j), verifieObjetString(values.get(1),i,j),
                            ...
                            verifieObjetString(values.get(11),i,j), verifieObjetDouble(values.get(12)), verifieObjetDouble(values.get(13)),
                            verifieObjetDouble(values.get(14)), verifieObjetDouble(values.get(15)), verifieObjetString(values.get(16),i,j),
	...
	public static double verifieObjetDouble(Object o) {
		cp++;
