...
import org.uweb.uv.dao.idao.IDaoJournal;
import org.uweb.uv.metier.imetier.IMetierJournal;

@Transactional
public class MetierJournalImpl implements IMetierJournal{
	private IDaoJournal dao;

	public IDaoJournal getDao() {
		return dao;
	}

	public void setDao(IDaoJournal dao) {
		this.dao = dao;
	}
