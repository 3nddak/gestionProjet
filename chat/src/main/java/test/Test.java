...
public class Test {
	...
	public static void main(String[] args) {
				...
				try {
					...
					IMetierUtilisateur metier = (IMetierUtilisateur) context.getBean("metier");
					...
					metier.login("sa", "admin");
					System.out.println("Resultat rechercheUser= "+metier.login("sa", "admin"));
