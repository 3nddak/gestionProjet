package com.ucad.chat.websockets;


import com.google.gson.Gson;
import com.ucad.chat.websockets.messages.ConnectionInfoMessage;
import com.ucad.chat.websockets.messages.MessageInfoMessage;
import com.ucad.chat.websockets.messages.StatusInfoMessage;
...
public class WebSocketCharServlet extends WebSocketServlet {
    ...
    private static class ChatConnection extends MessageInbound {
        ...
        protected void onBinaryMessage(ByteBuffer byteBuffer) throws IOException {
            throw new UnsupportedOperationException("les messages binaires ne sont pas supportés");
        }
        ...
        protected void onTextMessage(CharBuffer charBuffer) throws IOException {
            ...
            if (destinationConnection != null) {
                ...
                log.warn("Utilisateur non connecté");
            }
        }
        ...
        private void sendConnectionInfo(WsOutbound outbound) {
            ...
            try {
                ...
                log.error("impossible d'envoyer le message", e);
            }
        }
